  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        {/* Section principale - 1 ou 2 colonnes selon la page */}
        <div className={`grid ${isHomePage ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1'} gap-8 mb-8`}>
          {/* Section Contact */}
          {isHomePage && (
          ...
          {/* Section Réseaux sociaux - visible seulement sur accueil */}
          {isHomePage && (
